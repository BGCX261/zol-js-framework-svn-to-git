 ...
 * @depends     zol-core, yahoo-dom-event
 */
ZOL.add("datalazyload", function(Z) {
    ...
    Z.mix(DataLazyload.prototype, {
        ...
        loadCustomLazyData: function(containers, type, flag) {
            ...
            // 遍历处理
            Z.each(containers, function(container) {
                switch (type) {
                    case "textarea-data":
    ...
    Z.mix(DataLazyload, DataLazyload.prototype, true, ["loadCustomLazyData", "_loadImgSrc", "_loadDataFromArea"]);

    Z.DataLazyload = DataLazyload;
});
