 ...
 * @depends     zol, yui-base, widget
 */
ZOL.add("switchable", function(Z) {
     ...
     *   - this.switchTimer
     */
    Z.Widget.prototype.switchable = function(config) {
        var self = this;
        config = config || {};
         ...
         * @type object
         */
        self.config[SWITCHABLE] = Z.merge(Switchable.Config, config || {});
        ...
        // attach and init
        Z.mix(self, Switchable.prototype, false);
        self._initSwitchable();

        return self; // support chain
    };

    Z.mix(Switchable.prototype, {
        ...
        _onMouseEnterTrigger: function(index) {
            var self = this;
            //Z.log("Triggerable._onMouseEnterTrigger: index = " + index);
        ...
        switchTo: function(index, direction) {
            ...
            //Z.log("Triggerable.switchTo: index = " + index);
    ...
    Z.augment(Switchable, Y.EventProvider);
    
    Z.Switchable = Switchable;
});
